    ...
    ERC20Recoverable
{
    ...
    function canModifyName(
        ...
        return
            ...
            !_is2LDInGracePeriod(fuses, expiry);
    }
    ...
    function unwrap2LD(
        ...
        address registrant,
        address controller
    ) public onlyTokenOwner(_makeNode(FIL_NODE, labelhash)) {
    ...
    function onERC721Received(
        ...
        _wrap2LD(label, owner, ownerControlledFuses, expiry, resolver);
