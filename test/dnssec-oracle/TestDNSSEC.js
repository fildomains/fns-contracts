...
// When the real test start failing due to ttl expiration, you can generate the new test dataset at https://dnssec.fns.domains/?domain=ethlab.xyz&mode=advanced
const test_rrsets = [
